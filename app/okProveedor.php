...
?>
 ...
 <section>   
  <div style="padding-top: 50px;"></div>
    <div style="width: 250px; height: 45px; background-color: #009245; margin: 0px auto; color: white; font-size: 18px; text-align: center;padding-top: 10px;"><b>Registro Completado</b></div>


    <div class="container" style="margin-top: 50px;">
     <p>Gracias por unirte a nuestra equipo de proveedores de servicio  FENET. Pronto uno de nuestros Asesores se pondrá en contacto para validar sus datos y finalizar el proceso de registro</p>
    </div>
    ...
    <div class="container">
     <p>Por favor lea los términos y condiciones del servicio.</p>
    </div>
