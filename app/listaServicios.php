        ...
        if (mysql_num_rows($rs)>0){
            ...
            while ($reg){
                ...
                echo "<td class='dark' align='center' style='border: inset 0pt' bgcolor='#ccc'> 
					...
					<form action='chatCliente.php' method='post'>
						<input type='hidden' name='servicio'  value=".$reg[0].">
						<input type='hidden' name='proveedor'  value=".$reg[10]."> 
						<input type='submit' style='width:250px; height:30px; cursor:pointer; background-color:#545454; color:white; border-radius:8px;' value='Chatea con el Proveedor' name='".$reg[0]."' />                         
					</form>
                </td>";
/*
